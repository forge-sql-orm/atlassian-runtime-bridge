...
/**
 * Spring {@link Component} implementing {@link ConfluenceProductAdapter} with
 * <strong>automatic</strong> Connect vs Forge delegation (same pattern as {@link
 * JiraProductSelectAdapter}).
 */
@Component
public class ConfluenceProductSelectAdapter implements ConfluenceProductAdapter {
  ...
  public ConfluenceProductSelectAdapter(
    ...
    this.confluenceProductForgeAdapter =
  ...
  public RestTemplate authenticatedAsAddon(AtlassianHost host) {
    return isForge()
        ? confluenceProductForgeAdapter.authenticatedAsAddon(host)
  ...
  public RestTemplate authenticatedAsCurrentUser() {
    return isForge()
        ? confluenceProductForgeAdapter.authenticatedAsCurrentUser()
  ...
  public RestTemplate impersonation(AtlassianHostUser hostUser) {
    return isForge()
        ? confluenceProductForgeAdapter.impersonation(hostUser)
