 ...
 *
 * <p>Application code depends on this interface only. The Forge bridge module registers an {@code
 * com.github.vzakharchenko.runtime.bridge.forge.products.OtherProductSelectAdapter} bean that
